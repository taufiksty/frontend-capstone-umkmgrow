	...
	return async (dispatch) => {
		...
		try {
			const response = await axios.get(
				`https://backend-capstone-umkmgrow.vercel.app/api/courses/${id}`,
			);
	...
	return async (dispatch) => {
		...
		try {
			...
			const responseModule = await axios.get(
				`https://backend-capstone-umkmgrow.vercel.app/api/courses/${id}/modules?content=true`,
...
export const retrieveCourseExams = (token, id) => {
	return async (dispatch) => {
		...
		try {
			const response = await axios.get(
				`https://backend-capstone-umkmgrow.vercel.app/api/courses/${id}/exams`,
				{
					headers: { Authorization: `Bearer ${token}` },
				},
			);
...
export const retrieveCourseExamHistory = (token, id) => {
	return async (dispatch) => {
		...
		try {
			const response = await axios.get(
				`https://backend-capstone-umkmgrow.vercel.app/api/courses/${id}/exams/history`,
				{
					headers: { Authorization: `Bearer ${token}` },
				},
			);
...
export const retrieveCourseCertification = (token, id) => {
	return async (dispatch) => {
		...
		try {
			const response = await axios.get(
				`https://backend-capstone-umkmgrow.vercel.app/api/courses/${id}/certification`,
				{
					headers: { Authorization: `Bearer ${token}` },
				},
			);
...
export const purchaseCourse = (token, enrollId) => {
	return async (dispatch) => {
		...
		try {
			const response = await axios.post(
				`https://backend-capstone-umkmgrow.vercel.app/api/enrollment/${enrollId}/purchase`,
				{},
				{ headers: { Authorization: `Bearer ${token}` } },
			);
			dispatch(fetchAPIFinish());
...
export const submitExam = (token, id, payload) => {
	return async (dispatch) => {
		...
		try {
			const response = await axios.post(
				`https://backend-capstone-umkmgrow.vercel.app/api/courses/${id}/exams/submit`,
				payload,
				{ headers: { Authorization: `Bearer ${token}` } },
			);
			dispatch(fetchAPIFinish());
